...
% Helical Actuator Visualization
% Copyright 2015 Kyle Zampaglione, Andrew P. Sabelhaus
% 5.1.15
% Calculates change in z height for twisting of the helical actuator, 
% the version with the curved rails that is actually a helix.
...
D = 2;
r = D/2;
%rungs= 6; % this variable is irrelevant.
...
for j = pi/100:0.1:K %pi/100:0.1:K
    ...
    set(gcf,'PaperPosition',[2.5,2.5,3.5,3.5]);
...
%Derivative; rate of change of length vs turns
figure
