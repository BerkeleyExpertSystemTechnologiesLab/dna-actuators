% simulation_straightline_experiment_directcalc.m
...
% then plots.
% This version uses the updated, directly-calculated equations for angle/height.
...
save_path_base_disp = '../img/comparison_plots_straightline_displacement_directcalc';
save_path_base_rate = '../img/comparison_plots_straightline_rate_directcalc';
...
[heights_1, rotations_1] = length_simulation_straightline_directcalc(1, 1, N, ...
    180 * (N-1));
[heights_2, rotations_2] = length_simulation_straightline_directcalc(2, 2, N, ...
    180 * (N-1));
[heights_3, rotations_3] = length_simulation_straightline_directcalc(3, 3, N, ...
    180 * (N-1));
